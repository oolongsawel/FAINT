	...
	$.getJSON("/member/followed/" + ${userVO.id}, function(data){
		...
		if(data.length!=0){
			...
			$("#followed").on("click", function(){
				...
				data.each(function(){
					if(this.isFollow>0){
						followedList+="<li><a href='/member/profile?nickname="+this.nickname+"'>" + this.nickname + "</a><button class='isFlw' title='"+this.id+"'>팔로잉</button></li>";
					}else if(this.isFollow==0 && this.id!=${login.id}){
						followedList+="<li><a href='/member/profile?nickname="+this.nickname+"'>" + this.nickname + "</a><button class='isFlw' title='"+this.id+"'>팔로우</button></li>";
					}else{
						followedList+="<li><a href='/member/profile?nickname="+this.nickname+"'>" + this.nickname + "</a></li>";
					}
				})
...
function following(){
	$.getJSON("/member/following/" + ${userVO.id}, function(data){
		...
		var data=$(data)
		if(data.length!=0){
			$("#following").html("<a href='#modalLayer' class='modalLink'>팔로우 "+data.length+"</a>");
			...
			$("#following").on("click", function(){
				...
				data.each(function(){
					if(this.isFollow>0){
						followingList+="<li><a href='/member/profile?nickname="+this.nickname+"'>" + this.nickname + "</a><button class='isFlw' title='"+this.id+"'>팔로잉</button></li>";
					}else if(this.isFollow==0 && this.id!=${login.id}){
						followingList+="<li><a href='/member/profile?nickname="+this.nickname+"'>" + this.nickname + "</a><button class='isFlw' title='"+this.id+"'>팔로우</button></li>";
					}else{
						followingList+="<li><a href='/member/profile?nickname="+this.nickname+"'>" + this.nickname + "</a></li>";
					}
				})
