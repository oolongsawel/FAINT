        ...
        <div class="card border-secondary mb-3 bd " style="max-width: 20rem;" id="formContent">
            ...
            <div class="card-body text-secondary" id="formFooter">
                ...
                <form name="login" action="/user/modifyAuthCheck" method="post">
                    ...
                    <input type="text" class="form-control" id="email" name="email" value="${login.email}" readonly autofocus>
                    <input type="password" class="form-control" id="password" name="password" placeholder="Password를 입력해주세요" autofocus >
