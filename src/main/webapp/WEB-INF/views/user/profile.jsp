...
<title>${memberVO.memberName}(@${memberVO.memberName})</title>
...
function getPostList(){
	$.getJSON("/post/" + uid, function(data){
		...
		var postCnt=0;
		$(data).each(function(){
			str = "<div id='feed"+this.memeberID+"'><li>"+this.memberID+ ":" +this.caption+"<ul id='post"+this.memeberID+"'></ul></li></div><br />";
			$("#postList").append(str);
			postCnt++;
			
			//게시물마다 댓글 등록창 등록
			var replystr="";
			var pid=this.memeberID; //게시물 id값
			getReplyList();
			...
			function getReplyList(){
				$.getJSON("/reply/post/" + pid, function(rpldata){
					...
					var postid=pid;
					var sid ='${login.memberID}'; //세션저장된 유저의 id값(로그인한 유저의 아이디 값)
