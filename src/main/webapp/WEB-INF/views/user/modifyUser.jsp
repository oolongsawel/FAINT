            ...
            <div class=" mt-5" >
                ...
                <div class=" form-group">
                    <div class="row input-group mb-3" style="margin-left: 17%" >
                        ...
                        <input type="text" style="border:0" class="col-6 input-group-text input-group-height" name="email" id="email" value="${login.email}" aria-describedby="basic-addon1" readonly/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row input-group "  style="margin-left:17%">
                        ...
                        <input type="text" maxlength="20" class="col-4 input-group-text input-group-height " aria-label="Amount (to the nearest dollar)"  style="border:0"
                               name="nickname" id="nickname" value="${login.nickname}" onkeyup="checkvalue()"/>
