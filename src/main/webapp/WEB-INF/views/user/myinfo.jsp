...
<div id="Account_information" class="tabcontent card mb-3 active" >
            ...
            <div class="row">
                <div class="col-12">
                    <div class="panel panel-7 ">
                        <p class="hn" style="font-size: 25px" ><a >"${login.nickname}" </a>님 반가워요~</p>
                    </div>
                </div>
                ...
                <div class="col-12 align-content-center" style="height: 340px;">
                    <p  class=" mt-3 bd " style="font-size: 30px">Email:<a class="ml-3" style="font-size:20px;">${login.email}</a></p>
                    <p  class=" mt-1 bd" style="font-size: 30px">Name:<a class="hn ml-3" style="font-size:20px;">${login.nickname}</a></p>
                    <div class="row">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#profile").attr("src", getFileInfo("${login.profilephoto}"));
        });
    </script>
</div>
