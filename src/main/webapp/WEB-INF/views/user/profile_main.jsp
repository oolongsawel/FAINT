...
<div>
	...
	<label>profile test</label>
		<ul>
			<li><a href="/member/profile?id=${memberID.memberID}">email = ${MemberVO.memberEmail}</a></li>
			<li>password = ${MemberVO.memberPassword}</li>
			<li>name = ${memberVO.memberName}</li>
			<li>nickname = ${memberVO.}</li>
		</ul>
</div>
